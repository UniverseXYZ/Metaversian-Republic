...
const Book = () => {
  let pages = [];
  let pagesUrls = [Page1, Page2, Page3, Page4, Page5, Page6, Page7, Page8, Page9, Page10, Page11, Page12];
  ...
  return (
    <Container id="storySection">
      <Box sx={{
        ...
        <HTMLFlipBook width={600} height={600} loadFromImages={['@app/assets/images/book-test-page.png']}>
          {pages}
        </HTMLFlipBook>
      </Box >
    </Container >
